...
resource "aws_subnet" "this" {
  for_each = {
    "pub_a" : ["192.168.1.0/24", "${var.aws_region}a", "Terraform Public A"]
    "pub_b" : ["192.168.2.0/24", "${var.aws_region}b", "Terraform Public B"]
    "pvt_a" : ["192.168.3.0/24", "${var.aws_region}a", "Terraform Private A"]
    "pvt_b" : ["192.168.4.0/24", "${var.aws_region}b", "Terraform Private B"]
  }
  vpc_id            = aws_vpc.this.id
